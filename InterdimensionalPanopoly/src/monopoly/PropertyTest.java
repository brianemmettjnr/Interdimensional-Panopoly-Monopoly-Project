...
public class PropertyTest {
	...
	public static void main(String[] args) {
		...
		RentalProperty marylebone = new Station("Marylebone Station");
		RentalProperty liverpool = new Station("Liverpool St. Station");
		...
		testPlayer.buyProperty(marylebone, marylebone.getPrice());
		...
		System.out.println("\nRent of Marylebone:\nExpected: 25\t\tActual: " + marylebone.getRentalAmount());
		...
		System.out.println("\nMortgage value of Liverpool St. Station:\nExpected: 100\t\tActual: " + liverpool.getMortgageAmount());
